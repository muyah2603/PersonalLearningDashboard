...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      loginUser(
        { _id: userData.id, name: userData.name, email: userData.email, avatar: userData.avatar },
        userData.token
      );
      navigate('/dashboard');
    } catch (err) {
        ...
        <form className="clean-form" onSubmit={handleSubmit}>
          ...
          <div className="clean-form-group">
            ...
            <input
              ...
              placeholder="name@gmail.com" className="clean-input"
          ...
          <div className="clean-form-group">
            ...
            <div className="password-wrapper">
              <input
                ...
                placeholder="••••••••" className="clean-input"
